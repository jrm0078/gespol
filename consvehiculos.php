...
<style>
    ...
    #tbl_vehiculos tbody tr:hover { background-color: rgba(0,132,217,0.04) !important; }
</style>
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header card-header-blue py-2">
            <h5 class="m-0 text-white"><i class="fas fa-car mr-2"></i>Vehículos</h5>
        </div>
        <div class="card-body p-2">
            <div class="tabla-toolbar">
                <div class="btn-group btn-group-sm" role="group">
                    <button id="btnTbAddVehiculo" class="btn btn-toolbar-action" title="Nuevo vehículo">
                        <i class="fas fa-plus"></i><span class="d-none d-sm-inline ml-1">Añadir</span>
                    </button>
                    <button id="btnTbEditVehiculo" class="btn btn-toolbar-action" title="Editar vehículo seleccionado" disabled>
            ...
            <div class="table-responsive">
                <table id="tbl_vehiculos" class="display" style="width:100%">
                    <thead>
                        <tr>
...
<div id="ctxMenuVehiculos" class="ctx-menu">
...
<script src="js/consvehiculos.js"></script>
