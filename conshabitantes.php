...
<style>
    ...
    #tbl_habitantes tbody tr:hover { background-color: rgba(0,132,217,0.04) !important; }
</style>
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header card-header-blue py-2">
            <h5 class="m-0 text-white"><i class="fas fa-users mr-2"></i>Habitantes</h5>
        </div>
        <div class="card-body p-2">
            <div class="tabla-toolbar">
                <div class="btn-group btn-group-sm" role="group">
                    <button id="btnTbAddHabitante" class="btn btn-toolbar-action" title="Nuevo habitante">
                        <i class="fas fa-plus"></i><span class="d-none d-sm-inline ml-1">A&ntilde;adir</span>
                    </button>
                    <button id="btnTbEditHabitante" class="btn btn-toolbar-action" title="Editar habitante seleccionado" disabled>
            ...
            <div class="table-responsive">
                <table id="tbl_habitantes" class="display" style="width:100%">
                    <thead>
                        <tr>
...
<div id="ctxMenuHabitantes" class="ctx-menu">
...
<script src="js/conshabitantes.js"></script>
