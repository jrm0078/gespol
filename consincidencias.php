...
<style>
    ...
    #tbl_incidencias tbody tr:hover { background-color:rgba(0,132,217,0.04)!important; }
</style>
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header card-header-blue py-2">
            <h5 class="m-0 text-white"><i class="fas fa-exclamation-triangle mr-2"></i>Incidencias</h5>
        </div>
        <div class="card-body p-2">
            <div class="tabla-toolbar">
                <div class="btn-group btn-group-sm" role="group">
                    <button id="btnTbAddIncidencia" class="btn btn-toolbar-action" title="Nueva incidencia">
                        <i class="fas fa-plus"></i><span class="d-none d-sm-inline ml-1">Añadir</span>
                    </button>
                    <button id="btnTbEditIncidencia" class="btn btn-toolbar-action" title="Editar" disabled>
            ...
            <div class="table-responsive">
                <table id="tbl_incidencias" class="display" style="width:100%">
                    <thead>
                        <tr>
...
<div id="ctxMenuIncidencias" class="ctx-menu">
...
<script src="js/consincidencias.js"></script>
