                ...
                <nav class="sidebar-nav">
					...
					<?php 
						...
						$menu= $menu . '<li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i><span class="hide-menu">Gestión Policial</span></li>';								$menu= $menu . '<li class="sidebar-item" id="mnuhabitantes" data-pagina="conshabitantes.php"> <a href="javascript:void(0)" class="sidebar-link"><i class="fas fa-users"></i><span class="hide-menu">Habitantes</span><i class="fas fa-external-link-alt sidebar-modal-icon" data-pagina="conshabitantes.php" data-titulo="Habitantes" data-icono="fas fa-users" title="Abrir en ventana emergente" style="margin-left:auto;font-size:0.7rem;opacity:0.6;"></i></a></li>';
								$menu= $menu . '<script>document.getElementById("mnuhabitantes").addEventListener("click", function(e){if(e.target.closest(".sidebar-modal-icon"))return;CargarPagina("conshabitantes.php","Habitantes","fas fa-users");}, false);</script>';						$menu= $menu . '<li class="sidebar-item" id="mnuagentes" data-pagina="consagentes.php"> <a href="javascript:void(0)" class="sidebar-link"><i class="fas fa-id-badge"></i><span class="hide-menu">Agentes</span><i class="fas fa-external-link-alt sidebar-modal-icon" data-pagina="consagentes.php" data-titulo="Agentes" data-icono="fas fa-id-badge" title="Abrir en ventana emergente" style="margin-left:auto;font-size:0.7rem;opacity:0.6;"></i></a></li>';
