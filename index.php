            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
					...
					<?php 
						...
						$menu= $menu . '<li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i><span class="hide-menu">Gestión Policial</span></li>';								$menu= $menu . '<li class="sidebar-item" id="mnuhabitantes" data-pagina="conshabitantes.php"> <a href="javascript:void(0)" class="sidebar-link"><i class="fas fa-users"></i><span class="hide-menu">Habitantes</span><i class="fas fa-external-link-alt sidebar-modal-icon" data-pagina="conshabitantes.php" data-titulo="Habitantes" data-icono="fas fa-users" title="Abrir en ventana emergente" style="margin-left:auto;font-size:0.7rem;opacity:0.6;"></i></a></li>';
								$menu= $menu . '<script>document.getElementById("mnuhabitantes").addEventListener("click", function(e){if(e.target.closest(".sidebar-modal-icon"))return;CargarPagina("conshabitantes.php","Habitantes","fas fa-users");}, false);</script>';
								$menu= $menu . '<li class="sidebar-item" id="mnuvehiculos" data-pagina="consvehiculos.php"> <a href="javascript:void(0)" class="sidebar-link"><i class="fas fa-car"></i><span class="hide-menu">Vehículos</span><i class="fas fa-external-link-alt sidebar-modal-icon" data-pagina="consvehiculos.php" data-titulo="Vehículos" data-icono="fas fa-car" title="Abrir en ventana emergente" style="margin-left:auto;font-size:0.7rem;opacity:0.6;"></i></a></li>';
								$menu= $menu . '<script>document.getElementById("mnuvehiculos").addEventListener("click", function(e){if(e.target.closest(".sidebar-modal-icon"))return;CargarPagina("consvehiculos.php","Vehículos","fas fa-car");}, false);</script>';
